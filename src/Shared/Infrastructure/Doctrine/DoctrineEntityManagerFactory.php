...
namespace JoseUgal\Shared\Infrastructure\Doctrine;

use JoseUgal\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
    private static array $sharedPrefixes = [
        __DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'JoseUgal\Shared\Domain',
    ];
